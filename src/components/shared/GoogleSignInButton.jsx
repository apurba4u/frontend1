...
export default function GoogleSignInButton() {
  ...
  return (
    <button
      ...
      disabled={isLoading}
      className="w-full flex items-center justify-center gap-3 py-3 px-4 rounded-xl border border-outline-variant/30 bg-surface-container hover:bg-surface-container-high transition-colors duration-200 font-medium text-on-surface disabled:opacity-50"
    >
      {isLoading ? (
